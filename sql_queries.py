...
CREATE TABLE IF NOT EXISTS songplays (songplay_id SERIAL, start_time bigint, user_id varchar, level varchar, song_id varchar, artist_id varchar, session_id int, location varchar, user_agent varchar);
""")
...
# INSERT RECORDS
# row.ts, row.userId, songid, artistid, sessionId, row.location, row.userAgent
